...
#import <camera_rm/RMFLTThreadSafeFlutterResult.h>

/// Methods exposed for unit testing.
@interface RMCameraPlugin ()
...
- (void)handleMethodCallAsync:(FlutterMethodCall *)call result:(RMFLTThreadSafeFlutterResult *)result;

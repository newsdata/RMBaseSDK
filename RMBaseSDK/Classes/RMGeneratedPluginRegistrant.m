...
#if __has_include(<camera_rm/RMCameraPlugin.h>)
#import <camera_rm/RMCameraPlugin.h>
#else
@import camera_rm;
#endif
...
#if __has_include(<flutter_inappwebview_rm/RMInAppWebViewFlutterPlugin.h>)
#import <flutter_inappwebview_rm/RMInAppWebViewFlutterPlugin.h>
#else
@import flutter_inappwebview_rm;
#endif
...
#if __has_include(<fluttertoast_rm/RMFluttertoastPlugin.h>)
#import <fluttertoast_rm/RMFluttertoastPlugin.h>
#else
@import fluttertoast_rm;
#endif
...
#if __has_include(<wakelock_rm/RMWakelockPlugin.h>)
#import <wakelock_rm/RMWakelockPlugin.h>
#else
@import wakelock_rm;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistrySDK>*)registry {
  ...
  [RMCameraPlugin registerWithRegistrar:[registry registrarForPlugin:@"RMCameraPlugin"]];
  ...
  [RMInAppWebViewFlutterPlugin registerWithRegistrar:[registry registrarForPlugin:@"RMInAppWebViewFlutterPlugin"]];
  ...
  [RMFluttertoastPlugin registerWithRegistrar:[registry registrarForPlugin:@"RMFluttertoastPlugin"]];
  ...
  [RMWakelockPlugin registerWithRegistrar:[registry registrarForPlugin:@"RMWakelockPlugin"]];
